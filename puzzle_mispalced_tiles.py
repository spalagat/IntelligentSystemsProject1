# -*- coding: utf-8 -*-
"""
Created on Fri Feb  8 23:10:26 2019
    ...
    for i in range(length):
        for j in range(length):
            ...
            if state[i][j] != goal_state[i][j] and state[i][j]!=0:
                #counting the misplaced tiles.
                h+=1
    return h

# This method returns the list child nodes of the parent node.                
        ...
        for j in range(len(state[i])):
            if state[i][j] == 0: 
                if (i==0 or i==length-1) and (j==0 or j==length-1):
                    ...
                    h1 = misplaced_tiles(s1,goal_state)
                    h2 = misplaced_tiles(s2,goal_state)
                    ...
                    h1 = misplaced_tiles(s1,goal_state)
                    h2 = misplaced_tiles(s2,goal_state)
                    h3 = misplaced_tiles(s3,goal_state)
                    # here we are finding the f(n) values
                    f1 = h1+g
                    f2 = h2+g
                    f3 = h3+g
                    ...
                    h2 = misplaced_tiles(s2,goal_state)
                    h3 = misplaced_tiles(s3,goal_state)
                    h4 = misplaced_tiles(s4,goal_state)
                    # here we are finding the f(n) values
                    f1 = h1+g
                    f2 = h2+g
                    f3 = h3+g
...
if __name__ == '__main__':
     ...
     h = misplaced_tiles(intial_state,goal_state)
     f= g+h
